...
import com.pb.dashboard.quality.logic.RPDisplayDataManager;
...
public class RejectedPaymentsView extends VerticalLayout implements View, Filterable {

    private static final long serialVersionUID = 2786984538238531067L;
    ...
    private RPDisplayDataManager dataManager = new RPDisplayDataManager(chartBuilder);

    public RejectedPaymentsView() {
        setSizeFull();
    ...
    private CssLayout createPanels() {
        ...
        content.setCaption("Забракованные платежи: Украина");
        return panel;
    }
    ...
    private VerticalLayout buildGeneralView() {
        ...
        generalChartView.addComponent(chartBuilder.getExcludedPaymentsChart());
