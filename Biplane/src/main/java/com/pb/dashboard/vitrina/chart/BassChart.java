...
public class BassChart extends AbstractVaadinChartExample {
    private static final long serialVersionUID = -3903938879751824386L;
    ...
    public Component getChart() {
        ...
        configuration.getTitle().setText("ТСО");
