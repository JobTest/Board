...
@Entity
public class SlaTimingDay implements SlaTimingI, Serializable {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(pkeySlaInterface, date, timingAvg, timing90, timing95, timing99, dateTime);
    }
    ...
    public boolean equals(Object obj) {
        ...
        final SlaTimingDay other = (SlaTimingDay) obj;
        return Objects.equals(this.pkeySlaInterface, other.pkeySlaInterface) && Objects.equals(this.date, other.date) && Objects.equals(this.timingAvg, other.timingAvg) && Objects.equals(this.timing90, other.timing90) && Objects.equals(this.timing95, other.timing95) && Objects.equals(this.timing99, other.timing99) && Objects.equals(this.dateTime, other.dateTime);
    }
}