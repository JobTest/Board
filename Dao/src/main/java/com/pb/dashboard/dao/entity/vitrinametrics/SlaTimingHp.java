...
@Entity
public class SlaTimingHp implements SlaTimingI, Serializable {
    ...
    public DateTime getDateTime() {
        if (dateTime == null) {
            ...
            dateTime = dateTime.withTime(hour, minuts, 0, 0);
        }
        return dateTime;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(pkeySlaInterface, date, hour, minuts, timingAvg, timing90, timing95, timing99, dateTime);
    }
    ...
    public boolean equals(Object obj) {
        ...
        final SlaTimingHp other = (SlaTimingHp) obj;
        return Objects.equals(this.pkeySlaInterface, other.pkeySlaInterface) && Objects.equals(this.date, other.date) && Objects.equals(this.hour, other.hour) && Objects.equals(this.minuts, other.minuts) && Objects.equals(this.timingAvg, other.timingAvg) && Objects.equals(this.timing90, other.timing90) && Objects.equals(this.timing95, other.timing95) && Objects.equals(this.timing99, other.timing99) && Objects.equals(this.dateTime, other.dateTime);
    }
}